...
[International Journal on Natural Language Computing](https://airccse.org/journal/ijnlc/index.html)

[Northern Sami YleAreena Subtitle Corpus](https://zenodo.org/records/14176353)

```bibtex
@dataset{huovinen_2024_14176353,
  author       = {Huovinen, Leo},
  title        = {Northern Sami YleAreena Subtitle Corpus},
  month        = nov,
  year         = 2024,
  publisher    = {Zenodo},
  doi          = {10.5281/zenodo.14176353},
  url          = {https://doi.org/10.5281/zenodo.14176353},
}
```
