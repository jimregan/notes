...
[Reel](https://www.instagram.com/reels/DZSoLEvIVl3/)

**Nagyon szeretnénk egy budapesti férfit.**

We would really like a man from Budapest.

```text
Nagyon  szeret-né-nk   egy  budapest-i  férfi-t.
very    want-COND-1PL  a    Budapest-ADJ man-ACC
```

**Nálunk ugye a sarokba azért állnak, mert büntetés van.**

Where we come from, people stand in the corner because they are being punished.

```text
Nál-unk  ugye  a    sarok-ba    azért
at-1PL   DM    the  corner-ILL  for.that

áll-nak,       mert     büntetés   van.
stand-3PL.INDF because  punishment be.3SG
```

**Én úgy hallottam, hogy itt vannak olyan sarkok, ahol a lányok más szándékkal állnak ki a sarokra.**

I heard that there are corners here where girls stand out on the corner with different intentions.

```text
Én   úgy   hall-ott-am,   hogy  itt   van-nak
1SG  thus  hear-PST-1SG   that  here  be-3PL

olyan  sarok-ok,  ahol   a    lány-ok
such   corner-PL  where  the  girl-PL

más    szándék-kal  áll-nak        ki  a
other  intention-INST stand-3PL.INDF PV  the
...
```text
Itt   van     egy  sarok.
here  be.3SG  a    corner
```

**Én ki akarok állni a sarokba.**

I want to stand out in the corner.

```text
Én   ki  akar-ok        áll-ni    a    sarok-ba.
1SG  PV  want-1SG.INDF  stand-INF the  corner-ILL
```

**Álljunk ki a sarokra.**

Let us stand out on the corner.

```text
Áll-j-unk        ki  a    sarok-ra.
stand-SBJV-1PL   PV  the  corner-SBL
```

**De ne legyél már ilyen sarki lányzó, repedtsarkú.**

But do not be such a street-corner girl, you cracked-heeled one.

```text
De   ne       legy-él       már  ilyen  sark-i
but  NEG.IMP  be-SBJV.2SG   DM   such   corner-ADJ

lányzó,  repedt-sark-ú.
girl     cracked-heel-PROP
```
...
```text
De   nek-em   nem  az.
but  DAT-1SG  NEG  that
```

**Mert mindig legyalulom egy jó kis téglával.**

Because I always plane it down with a nice little brick.

```text
Mert     mindig  le-gyalul-om      egy  jó
because  always  PV-plane-1SG.DEF  a    good

kis     téglá-val.
little  brick-INST
```

**Kétszáz forint egy hűtőmágnes.**

A fridge magnet costs two hundred forints.

```text
Két-száz    forint  egy  hűtő-mágnes.
two-hundred forint  a    fridge-magnet
```

**Hát abból otthon veszünk tíz tojást.**

Well, at home we can buy ten eggs for that.

```text
Hát  az-ból    otthon   vesz-ünk      tíz  tojás-t.
DM    that-ELA  at.home  buy-1PL.INDF  ten  egg-ACC
```

**Mondjuk nekünk ugye ingyen van a tojás.**

Though for us, of course, eggs are free.

```text
Mondjuk  nek-ünk  ugye  ingyen  van     a    tojás.
though   DAT-1PL  DM    free    be.3SG  the  egg
```

**Mert a tyúkok ingyen tojják.**

Because the hens lay them for free.

```text
Mert     a    tyúk-ok  ingyen  toj-já-k.
because  the  hen-PL   free    lay-3PL.DEF
```

**Utca, utca, Váci utca, drága bolttal van kirakva.**

Street, street, Váci Street—it is lined with expensive shops.

```text
Utca,   utca,   Váci_utca,  drága      bolt-tal
street  street  Váci_Street expensive  shop-INST

van     ki-rak-va.
be.3SG  PV-put-PASS.CVB
```

**Tényleg megkérdezted a mamát, hogy hogy van az izé, a Gézus?**

Did you really ask Grandma how the thingy—Gézus—is doing?

```text
Tényleg  meg-kérdez-t-ed      a    mamá-t,
really   PV-ask-PST-2SG.DEF   the  grandma-ACC

hogy  hogy  van     az   izé,    a    Gézus?
that  how   be.3SG  the  thingy  the  Gézus
```

**A tyúk. A tojótyúk.**

The hen. The laying hen.
...
**Hát annak, annak gatya.**

Well, that one is done for. Completely done for.

```text
Hát  annak,    annak     gatya.
DM    that.DAT  that.DAT  underpants
```
...
Are they going to eat it for dinner?

```text
Meg-esz-ik       vacsorá-ra?
PV-eat-3PL.DEF   dinner-SBL
```

**Befőzik a jövő heti levesbe.**

They will cook it into next week’s soup.

```text
Be-főz-ik       a    jövő  het-i     leves-be.
PV-cook-3PL.DEF the  next  week-ADJ  soup-ILL
```

**Drága bolttal van kirakva!**

It is lined with expensive shops!

```text
Drága      bolt-tal  van     ki-rak-va!
expensive  shop-INST be.3SG  PV-put-PASS.CVB
```

## A2 vocabulary

* **nálunk** — where we live; at our place
* **sarok** — corner
* **büntetés** — punishment
* **úgy hallottam, hogy…** — I heard that…
* **szándék** — intention
* **kiáll valahová** — go out and stand somewhere
* **sarki lány** — streetwalker; prostitute
* **repedtsarkú** — having cracked heels
* **legyalul** — plane or shave something down
* **tégla** — brick
* **hűtőmágnes** — fridge magnet
* **abból** — from that; for that amount
* **ingyen** — free of charge
* **tyúk** — hen
* **tojik** — lay eggs
* **ki van rakva valamivel** — be covered or lined with something
* **izé** — thingy; whatchamacallit
* **tojótyúk** — laying hen
* **annak gatya** — it is finished; it is done for
* **megeszik** — eat it
* **vacsorára** — for dinner
* **befőz** — preserve or cook something in
* **jövő heti** — next week’s
