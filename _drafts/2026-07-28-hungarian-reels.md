...
[Reel](https://www.instagram.com/reels/DXvxTrhqZJo/)

**Hat dolog, amit Emirates-egyenruhában tilos csinálni.**

Six things that are forbidden while wearing an Emirates uniform.

```text
Hat  dolog,  ami-t    Emirates-egyenruhá-ban
six  thing   REL-ACC  Emirates-uniform-INE

tilos      csinál-ni.
forbidden  do-INF
```

**1. Alkoholt fogyasztani, dohányozni**

1. Drink alcohol or smoke.

```text
Alkohol-t  fogyaszt-ani,  dohányoz-ni.
alcohol-ACC consume-INF   smoke-INF
```

**Tilos egyenruhában alkoholt fogyasztani vagy dohányozni, ugyanis ez rontja a professzionális összképet.**

It is forbidden to drink alcohol or smoke while in uniform, because this damages the overall professional image.

```text
Tilos      egyenruhá-ban  alkohol-t  fogyaszt-ani
forbidden  uniform-INE    alcohol-ACC consume-INF

vagy  dohányoz-ni,  ugyanis  ez    ront-ja
or    smoke-INF     because  this  damage-3SG.DEF

a    professzionális  össz-kép-et.
the  professional    overall-image-ACC
```
...
```text
Teljes-en  ért-hető.
complete-ADV understand-POT.PTCP
```

**Itt az alkoholfogyasztásnál olyasmire gondolok, hogy a hotellobbyban várakozol, hogy be tudjál jelentkezni a hotelbe, és elfoglalhasd a szobádat.**

Here, by drinking alcohol, I mean something like waiting in the hotel lobby to check in and take possession of your room.

```text
Itt   az   alkohol-fogyasztás-nál  olyas-mi-re
here  the  alcohol-consumption-ADE such-thing-SBL

gondol-ok,      hogy  a    hotel-lobby-ban
think-1SG.INDF  that  the  hotel-lobby-INE

várakoz-ol,      hogy  be  tud-j-ál
wait-2SG.INDF    that  PV  can-SBJV-2SG

jelentkez-ni  a    hotel-be,  és   el-foglal-hass-ad
check.in-INF  the  hotel-ILL  and  PV-occupy-POT-SBJV-2SG.DEF

a    szobá-d-at.
the  room-2SG.POSS-ACC
```

**Akkor nyilván nem megengedett az alkoholfogyasztás.**

In that situation, drinking alcohol is obviously not permitted.

```text
Akkor  nyilván    nem  meg-enged-ett
then   obviously  NEG  PV-permit-PTCP.PST

az   alkohol-fogyasztás.
the  alcohol-consumption
```

**A dohányzásnál meg nyilván olyasmire gondolok, hogy lehet, hogy te korábban odaérkeztél már a reptérre, de már ugye rajtad volt az egyenruha, úgyhogy már nem gyújthattál rá.**

And by smoking, I mean something like having arrived at the airport early, but already being in uniform, so you could no longer light up.

```text
A    dohányzás-nál  meg  nyilván    olyas-mi-re
the  smoking-ADE    DM   obviously  such-thing-SBL

gondol-ok,      hogy  lehet,      hogy  te
think-1SG.INDF  that  be.POT.3SG  that  2SG

korábban  oda-érkez-t-él       már  a    reptér-re,
earlier   there-arrive-PST-2SG  already the airport-SBL

de   már      ugye  rajt-ad    volt
but  already  DM    on-2SG     be.PST.3SG

az   egyenruha,  úgyhogy  már      nem
the  uniform     so       already  NEG

gyújt-hat-t-ál   rá.
light-POT-PST-2SG onto.it
```

**2. Telefont használni**

2. Use a phone.

```text
Telefon-t  használ-ni.
telephone-ACC use-INF
```

**Mert annak idején telefont használni abszolút nem lehetett.**

Because back then, using a phone was absolutely not allowed.

```text
Mert     annak_idején  telefon-t
because  back.then     telephone-ACC

használ-ni  abszolút  nem  lehet-ett.
use-INF     absolutely NEG  be.possible-PST.3SG
```

**Tehát hogyha meglátták, hogy te egyenruhában vagy, és elővetted a telefonodat, akkor azért vagy rád szóltak, vagy már jelentettek is.**

So if they saw that you were in uniform and had taken out your phone, they would either tell you off or even report you.

```text
Tehát  hogyha  meg-lát-t-á-k,       hogy  te
so     if      PV-see-PST-3PL.DEF    that  2SG

egyenruhá-ban  vagy,    és   elő-vet-t-ed
uniform-INE    be.2SG   and  out-take-PST-2SG.DEF

a    telefon-od-at,         akkor  azért
the  telephone-2SG.POSS-ACC then   DM

vagy  rá-d       szól-t-ak,    vagy  már
either onto-2SG  speak-PST-3PL or    already

jelent-ett-ek  is.
report-PST-3PL also
```

**Tehát mostanában már sokat látni, hogy rengeteg szelfi és videó készül egyenruhában.**

So nowadays you often see that a great many selfies and videos are made while in uniform.

```text
Tehát  mostaná-ban  már      sok-at    lát-ni,
so     nowadays-INE already  much-ACC  see-INF

hogy  rengeteg  szelfi  és   videó
that  numerous  selfie  and  video

készül        egyenruhá-ban.
be.made.3SG   uniform-INE
```

**Ami egyértelműen úgy készül, hogy közben ugye dolgoznak, vagy egyenruha van rajtuk, és már akkor csinálják a szelfiket.**

They are clearly being made while the people are working or wearing their uniforms, and they take the selfies right then.

```text
Ami  egyértelmű-en  úgy   készül,
REL  clear-ADV      thus  be.made.3SG

hogy  közben  ugye  dolgoz-nak,    vagy
that  during  DM    work-3PL.INDF   or

egyenruha  van     rajt-uk,  és   már
uniform    be.3SG  on-3PL    and  already

akkor  csinál-já-k    a    szelfi-k-et.
then   do-3PL.DEF     the  selfie-PL-ACC
```

**Ezt régen nem lehetett megtenni.**

You could not do this in the past.

```text
Ez-t      régen   nem  lehet-ett
this-ACC  formerly NEG  be.possible-PST.3SG

meg-ten-ni.
PV-do-INF
```

**Nyilvános helyen nem vehetted elő a telefonodat, azért sem, hogy csak készíts egy szelfit vagy videózgass.**

You could not take out your phone in a public place, not even merely to take a selfie or make some videos.

```text
Nyilvános  hely-en  nem  vehet-t-ed
public     place-SUP NEG  take-POT-PST-2SG.DEF

elő  a    telefon-od-at,         azért  sem,
out  the  telephone-2SG.POSS-ACC even.for.that NEG

hogy  csak  készít-s       egy  szelfi-t,
that  only  make-SBJV.2SG  a    selfie-ACC

vagy  videó-z-gass.
or    video-ITER-SBJV.2SG
```

**3. Aludni, a szemedet becsukni**

3. Sleep or close your eyes.

```text
Alud-ni,  a    szem-ed-et
sleep-INF the  eye-2SG.POSS-ACC

be-csuk-ni.
PV-close-INF
```

**Ugye ez elég egyértelmű, de nyilvános helyen nem lehet aludni, vagy akár lecsukni a szemeidet.**

This is fairly obvious, but you cannot sleep or even close your eyes in a public place.

```text
Ugye  ez    elég   egyértelmű,  de
DM    this  fairly clear         but

nyilvános  hely-en  nem  lehet
public     place-SUP NEG  be.possible.3SG

alud-ni,   vagy  akár  le-csuk-ni
sleep-INF  or    even  PV-close-INF

a    szem-e-id-et.
the  eye-POSS-2SG.POSS-ACC
```

**Főleg a jump seaten, egy fárasztó járat után.**

Especially on the jump seat after an exhausting flight.

```text
Főleg       a    jump_seat-en,  egy  fáraszt-ó
especially  the  jump_seat-SUP  a    tire-PTCP

járat  után.
flight after
```

**Nagyon gyakran előfordul egyébként rengeteg crew-val, hogy miután abbahagyod a mozgást, és leülsz a jump seatre landoláshoz, nem bírod már egyszerűen nyitva tartani a szemedet.**

It very often happens to many crew members that once you stop moving and sit down on the jump seat for landing, you simply cannot keep your eyes open any longer.

```text
Nagyon  gyakran  elő-fordul      egyébként
very    often    PV-occur.3SG    incidentally

rengeteg  crew-val,  hogy  miután
numerous  crew-INST  that  after

abba-hagy-od       a    mozgás-t,  és
leave-stop-2SG.DEF the  movement-ACC and

le-ül-sz        a    jump_seat-re  landolás-hoz,
PV-sit-2SG.INDF the  jump_seat-SBL landing-ALL

nem  bír-od       már      egyszerű-en
NEG  manage-2SG.DEF already simple-ADV

nyit-va  tart-ani  a    szem-ed-et.
open-CVB keep-INF  the  eye-2SG.POSS-ACC
```

**És csukódik, csukódik, csukódik a fejed, és folyamatosan csuklik lefelé.**

And your head keeps dropping and dropping and dropping, continually nodding downwards.

```text
És  csukód-ik,  csukód-ik,  csukód-ik
and close-3SG   close-3SG   close-3SG

a    fej-ed,          és   folyamatos-an
the  head-2SG.POSS    and  continuous-ADV

csukl-ik       le-felé.
droop-3SG      down-DIR
```

**Na, hogyha erről valaki csinált egy képet, akár egy utas, vagy valaki jelentett, akkor nagy bajban voltál.**

Well, if someone—perhaps a passenger—took a photograph of this, or someone reported you, then you were in serious trouble.

```text
Na,  hogyha  erről       valaki   csinál-t
DM   if      about.this  someone  make-PST.3SG

egy  kép-et,   akár  egy  utas,      vagy
a    picture-ACC even  a    passenger  or

valaki   jelent-ett,      akkor  nagy  baj-ban
someone  report-PST.3SG   then   big   trouble-INE

volt-ál.
be.PST-2SG
```

**Kivéve, ha esetleg ki tudtad magadat magyarázni, hogy te csak imádkoztál, és azért volt úgy becsukva a szemed.**

Unless you could perhaps talk your way out of it by saying that you were merely praying, which was why your eyes were closed.

```text
Kivéve  ha  esetleg  ki  tud-t-ad
except  if  perhaps   PV  can-PST-2SG.DEF

mag-ad-at          magyaráz-ni,  hogy  te
self-2SG.POSS-ACC  explain-INF   that  2SG

csak  imádkoz-t-ál,  és   azért
only  pray-PST-2SG  and  for.that

volt         úgy   be-csuk-va  a    szem-ed.
be.PST.3SG   thus  PV-close-CVB the  eye-2SG.POSS
```

**4. Hiányos egyenruhában megjelenni**

4. Appear in an incomplete uniform.

```text
Hiány-os    egyenruhá-ban  meg-jelen-ni.
lack-ADJ    uniform-INE    PV-appear-INF
```

**Smink nélkül vagy rendezetlen frizurával, rendezetlen egyenruhában megjelenni nem lehetett.**

You were not allowed to appear without makeup, with untidy hair or in an untidy uniform.

```text
Smink  nélkül  vagy  rendezetlen  frizurá-val,
makeup without or    untidy       hairstyle-INST

rendezetlen  egyenruhá-ban  meg-jelen-ni
untidy       uniform-INE    PV-appear-INF

nem  lehet-ett.
NEG  be.possible-PST.3SG
```

**Tehát az egyenruhának teljes szettben kellett lennie mindig.**

The uniform therefore always had to be a complete set.

```text
Tehát  az   egyenruhá-nak  teljes  szett-ben
so     the  uniform-DAT     complete set-INE

kell-ett       len-ni-e    mindig.
must-PST.3SG   be-INF-3SG  always
```

**Tehát azt nem csinálhattad meg, hogy – szintén hotellobbys példa – várakozol a hotellobbyban, vagy csak sétálsz a reptéren, és leveszed a kalapodat.**

So you could not, again using the hotel-lobby example, wait in the lobby or merely walk around the airport and take off your hat.

```text
Tehát  az-t      nem  csinál-hat-t-ad
so     that-ACC  NEG  do-POT-PST-2SG.DEF

meg,  hogy  szintén  hotel-lobby-s  példa,
PV    that  likewise  hotel-lobby-ADJ example

várakoz-ol       a    hotel-lobby-ban,
wait-2SG.INDF    the  hotel-lobby-INE

vagy  csak  sétál-sz       a    reptér-en,
or    only  walk-2SG.INDF   the  airport-SUP

és   le-vesz-ed        a    kalap-od-at.
and  PV-take-2SG.DEF   the  hat-2SG.POSS-ACC
```

**A kalapnak akkor rajtad kellett lennie.**

At that point, the hat had to remain on your head.

```text
A    kalap-nak  akkor  rajt-ad  kell-ett
the  hat-DAT    then   on-2SG   must-PST.3SG

len-ni-e.
be-INF-3SG
```

**Megvoltak a szabályok, hogy mikor mit kellett viselni.**

There were rules governing what had to be worn and when.

```text
Meg-vol-t-ak       a    szabály-ok,  hogy
PV-be-PST-3PL      the  rule-PL      that

mikor  mi-t      kell-ett       visel-ni.
when   what-ACC  must-PST.3SG   wear-INF
```

**És ezt csak teljes szettben, kivasalt egyenruhában, full sminkben, feltűzött frizurával lehetett tenni.**

And you could only do this in the complete set, with an ironed uniform, full makeup and pinned-up hair.

```text
És  ez-t      csak  teljes  szett-ben,
and  this-ACC  only  complete set-INE

ki-vasal-t       egyenruhá-ban,  full  smink-ben,
PV-iron-PTCP.PST uniform-INE     full  makeup-INE

fel-tűz-ött      frizurá-val  lehet-ett
PV-pin-PTCP.PST  hairstyle-INST be.possible-PST.3SG

ten-ni.
do-INF
```

**5. Nyilvános érzelemnyilvánítás**

5. Public displays of emotion or affection.

```text
Nyilvános  érzelem-nyilvánítás.
public     emotion-expression
```

**Nem ajánlatos a nyilvános érzelemnyilvánítás, tehát a hirtelen indulatkitörések.**

Public displays of emotion—such as sudden angry outbursts—were discouraged.

```text
Nem  ajánlat-os  a    nyilvános
NEG  recommend-ADJ the  public

érzelem-nyilvánítás,  tehát  a    hirtelen
emotion-expression    namely  the  sudden

indulat-kitörés-ek.
emotion-outburst-PL
```

**Tehát veszekedni, kiabálni egyenruhában ugye nem is néz ki jól, meg nem is szabad.**

Arguing or shouting while in uniform does not look good, of course, and is not allowed either.

```text
Tehát  veszeked-ni,  kiabál-ni  egyenruhá-ban
so     argue-INF      shout-INF  uniform-INE

ugye  nem  is    néz   ki  jól,  meg
DM    NEG  also  look  PV  well  and

nem  is    szabad.
NEG  also  permitted
```

**Valamint ugyanúgy nem volt megengedett mondjuk a csókolózás, ölelkezés, kézen fogás másokkal.**

Likewise, kissing, embracing or holding hands with other people was not permitted.

```text
Valamint  ugyan-úgy  nem  volt
also      same-way   NEG  be.PST.3SG

meg-enged-ett  mondjuk  a    csókoló-zás,
PV-permit-PTCP  for.example the kiss-RECIP-NMLZ

ölelkez-és,  kéz-en  fog-ás  más-ok-kal.
embrace-NMLZ hand-SUP hold-NMLZ other-PL-INST
```

**Tehát ilyen jellegű érzelemnyilvánítások nem voltak megengedettek.**

So displays of emotion or affection of this kind were not permitted.

```text
Tehát  ilyen  jelleg-ű    érzelem-nyilvánítás-ok
so     such   character-PROP emotion-expression-PL

nem  volt-ak      meg-enged-ett-ek.
NEG  be.PST-3PL   PV-permit-PTCP-PL
```

**6. Politikai vagy vallási véleménynyilvánítás, utasok szidása**

6. Expressing political or religious opinions, or bad-mouthing passengers.

```text
Politika-i  vagy  vallás-i   vélemény-nyilvánítás,
politics-ADJ or    religion-ADJ opinion-expression

utas-ok     szid-ás-a.
passenger-PL scold-NMLZ-3SG.POSS
```

**Közösségi médián szintén nem lehetett egyenruhában vallási véleményt, politikai véleményt nyilvánítani, vagy egyszerűen csak utasokat szidni.**

On social media, you were likewise not allowed to express religious or political opinions while in uniform, or simply to bad-mouth passengers.

```text
Közösségi  médiá-n  szintén  nem  lehet-ett
social     media-SUP likewise  NEG  be.possible-PST.3SG

egyenruhá-ban  vallás-i   vélemény-t,
uniform-INE    religion-ADJ opinion-ACC

politika-i  vélemény-t  nyilvánít-ani,
politics-ADJ opinion-ACC express-INF

vagy  egyszerű-en  csak  utas-ok-at
or    simple-ADV   only  passenger-PL-ACC
...
* **tilos** — forbidden
* **egyenruhában** — while wearing a uniform
* **alkoholt fogyaszt** — consume alcohol
* **dohányzik** — smoke
* **rontja az összképet** — damage the overall impression
* **olyasmire gondol** — mean something like
* **várakozik** — wait
* **bejelentkezik a hotelbe** — check into a hotel
* **elfoglalja a szobáját** — take possession of one’s room
* **megengedett** — permitted
* **odaérkezik** — arrive there
* **rágyújt** — light a cigarette; start smoking
* **annak idején** — back then
* **elővesz** — take out
* **rászól valakire** — tell someone off
* **jelent valakit** — report someone
* **mostanában** — nowadays
* **nyilvános hely** — public place
* **lecsukja a szemét** — close one’s eyes
* **fárasztó** — exhausting
* **előfordul** — happen; occur
* **abbahagyja a mozgást** — stop moving
* **nyitva tartja a szemét** — keep one’s eyes open
* **bajban van** — be in trouble
* **kimagyarázza magát** — talk one’s way out of something
* **imádkozik** — pray
* **hiányos** — incomplete
* **rendezetlen** — untidy
* **teljes szett** — complete set
* **kivasalt** — ironed
* **feltűzött frizura** — pinned-up hairstyle
* **érzelemnyilvánítás** — display of emotion or affection
* **indulatkitörés** — emotional or angry outburst
* **veszekedik** — argue
* **kiabál** — shout
* **csókolózik** — kiss
* **ölelkezik** — embrace
