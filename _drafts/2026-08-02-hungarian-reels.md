...
```text
Lehet        két  ember-t  szeret-ni?
be.POT.3SG   two  person-ACC love-INF
```

**Normális az, ha egyszerre két különböző emberbe vagy szerelmes?**

Is it normal if you are in love with two different people at the same time?

```text
Normális  az,    ha  egyszer-re  két  különböző
normal    that   if  one-TEMP    two  different

ember-be    vagy      szerelmes?
person-ILL  be.2SG    in.love
```
...
```text
Új-abb   tabu   téma.
new-CMPR taboo  topic
```

**A társadalom azt mondja, hogy nem.**

Society says no.

```text
A    társadalom  az-t      mond-ja,      hogy  nem.
the  society     that-ACC  say-3SG.DEF   that  NEG
```

**A pszichológia és az emberi szív viszont azt mondja, hogy igen.**

Psychology and the human heart, however, say yes.

```text
A    pszichológia  és   az   ember-i  szív
the  psychology    and  the  human-ADJ heart

viszont  az-t      mond-ja,      hogy  igen.
however  that-ACC  say-3SG.DEF   that  yes
```

**Biológiailag teljesen lehetséges.**

Biologically, it is completely possible.

```text
Biológia-i-lag  teljes-en  lehet-séges.
biology-ADJ-ADV complete-ADV be.possible-ADJ
```

**A lélek szintjén nincsenek földi korlátok.**

At the level of the soul, there are no earthly limits.

```text
A    lélek  szint-jé-n         nincs-enek
the  soul   level-3SG.POSS-SUP NEG.be-3PL

föld-i     korlát-ok.
earth-ADJ  limit-PL
```

**Előfordulhat, hogy a jelenlegi életedben két olyan lélekkel is találkozol, akikkel erős szövetség van köztetek.**

It may happen that in your current life you meet two such souls with whom there is a strong bond between you.

```text
Elő-fordul-hat,      hogy  a    jelenleg-i
PV-occur-POT.3SG     that  the  current-ADJ

élet-ed-ben      két  olyan  lélek-kel  is
life-2SG.POSS-INE two  such   soul-INST  also

találkoz-ol,      aki-k-kel   erős  szövetség
meet-2SG.INDF     REL-PL-INST strong bond

van     közt-etek.
be.3SG  between-2PL
```

**Mert az emberi szív nem egy ilyen fix darab torta, ami egyszer elfogy.**

Because the human heart is not some fixed piece of cake that eventually runs out.

```text
Mert     az   ember-i  szív   nem  egy  ilyen
because  the  human-ADJ heart  NEG  a    such

fix   darab  torta,  ami  egyszer  el-fogy.
fixed piece  cake    REL  once     PV-run.out.3SG
```

**Gyakran ráadásul azért esel szerelembe két emberrel, mert az egyik a biztonságot, az otthont, a nyugalmat képviseli.**

Often, moreover, you fall in love with two people because one represents safety, home and calm.

```text
Gyakran  ráadásul  azért      es-el
often    moreover   for.that   fall-2SG.INDF

szerelem-be  két  ember-rel,  mert     az   egy-ik
love-ILL     two  person-INST because  the  one-ONE

a    biztonság-ot,  az   otthon-t,  a
the  safety-ACC     the  home-ACC   the

nyugalom-at  képvisel-i.
calm-ACC     represent-3SG.DEF
```

**A másik pedig a kiszámíthatatlanságot, a tüzet, az újdonságot.**

The other, meanwhile, unpredictability, fire and novelty.

```text
A    más-ik    pedig    a    ki-számít-hatatlan-ság-ot,
the  other-ONE however  the  PV-calculate-NEG.POT-NMLZ-ACC

a    tűz-et,   az   új-donság-ot.
the  fire-ACC  the  new-NMLZ-ACC
```

**Két különböző szükségletedre válaszolnak.**

They respond to two different needs of yours.

```text
Két  különböző  szükséglet-ed-re      válaszol-nak.
two  different   need-2SG.POSS-SBL     respond-3PL
```

**És itt van a csapda is.**

And this is where the trap is too.

```text
És  itt   van     a    csapda  is.
and  here  be.3SG  the  trap    also
```

**A monogám kultúrákban az érzés hiába valóságos, a döntésednek tisztának kell lennie.**

In monogamous cultures, even if the feeling is real, your decision has to be clear.

```text
A    monogám  kultúrá-k-ban  az   érzés   hiába
the  monogamous culture-PL-INE the feeling  although

valóság-os,  a    döntés-ed-nek       tisztá-nak
reality-ADJ  the  decision-2SG.POSS-DAT clear-DAT

kell       len-ni-e.
must.3SG   be-INF-3SG
```

**Nem az a kérdés, hogy mit érzel, hanem az, hogy mit kezdesz vele.**

The question is not what you feel, but what you do with it.

```text
Nem  az    a    kérdés,   hogy  mi-t      érzel,
NEG  that  the  question  that  what-ACC  feel.2SG

hanem       az,    hogy  mi-t      kezd-esz
but.rather  that   that  what-ACC  begin-2SG

vel-e.
with-3SG
```

**Mind a két szerelem lehet valóságos és egy reális érzés.**

Both loves can be real and a genuine feeling.

```text
Mind  a    két  szerelem  lehet
both  the  two  love      be.POT.3SG

valóság-os  és   egy  reális  érzés.
reality-ADJ and  a    real    feeling
```
...
* **különböző** — different
* **szerelmes valakibe** — in love with someone
* **tabu téma** — taboo topic
* **társadalom** — society
* **emberi** — human
* **szív** — heart
* **lehetséges** — possible
* **lélek** — soul
* **szintjén** — at the level of
* **korlát** — limit; restriction
* **előfordulhat** — it may happen
* **jelenlegi** — current; present
* **szövetség** — alliance; bond
* **köztetek** — between you, plural
* **elfogy** — run out
* **ráadásul** — moreover
* **szerelembe esik** — fall in love
* **biztonság** — safety; security
* **nyugalom** — calm; tranquillity
* **képvisel** — represent
* **kiszámíthatatlanság** — unpredictability
* **újdonság** — novelty; something new
* **szükséglet** — need
* **válaszol valamire** — respond to something
* **csapda** — trap
* **monogám** — monogamous
* **hiába** — even though; despite
* **valóságos** — real
* **döntés** — decision
