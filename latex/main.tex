...
%The initial revolutionary phase of deep learning-based speech recognition seems to have calmed; at the moment, there is something of a trend towards reappraising older methods and components within the new framework. \citet{baevski_unsupervised_2021} use a new feature extractor, but use it to train a Kaldi system, while \citet{hsu_hubert_2021} use the old feature extraction method (MFCCs). \citet{hannun_differentiable_2020} reformulate Weighted Finite-State Transducers to be differentiable. \citet{zeyer_ctc_2017} found that CTC is a special case of Hidden Markov Models.
